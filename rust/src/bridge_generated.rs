...
fn wire_decode_single_frame_image_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Frame, _>(
        ...
        move || {
            ...
            move |task_callback| Result::<_, ()>::Ok(decode_single_frame_image(api_avif_bytes))
        },
    )
}
fn wire_init_memory_decoder_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, AvifInfo, _>(
        WrapInfo {
        ...
        move || {
            ...
            let api_avif_bytes = avif_bytes.wire2api();
            move |task_callback| Result::<_, ()>::Ok(init_memory_decoder(api_key, api_avif_bytes))
        },
    )
}
...
impl rust2dart::IntoIntoDart<AvifInfo> for AvifInfo {
